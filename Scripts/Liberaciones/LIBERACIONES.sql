...
BEGIN
    ...
    DECLARE C_ALMAPER CURSOR FOR
        SELECT
            ...
            C.CUBALC, C.TDRALC,
            D.NPRLBR, D.CRPRS, D.FFRMRP, D.HULTAC,
            E.NEXWRR,
        ...
        FROM
            ...
            LEFT OUTER JOIN DC@ALMAPER.ZZWT93 D ON A.NLBRC = D.NLBRRL AND D.STPENT = 'B' AND B.CFNNC = D.CENTD
    ...
    DECLARE C_RNSLIB CURSOR FOR
        ...
        FROM
            ...
            LEFT OUTER JOIN DC@RNSLIB.ZZWT93 D ON A.NLBRC = D.NLBRRL AND D.STPENT = 'B' AND B.CFNNC = D.CENTD
    ...
    DECLARE C_ALMAPER CURSOR FOR
        ...
        WHERE
            ...
            (
                ...
                OR
                (
                    PARAM_NLBRC IS NOT NULL AND A.NLBRC = PARAM_NLBRC
                )
            );
