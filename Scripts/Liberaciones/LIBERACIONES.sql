...
BEGIN
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_LIB_CONSULTA_LIBERACIONES_CABECERA', PARAMETROS, '');
END
GO
...
BEGIN
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_LIB_CONSULTA_LIBERACIONES_DETALLE', PARAMETROS, '');
END
GO
...
BEGIN
    ...
    DECLARE C_ALMAPER CURSOR FOR
        ...
        WHERE
        	(PARAM_STPQRY='C' AND A.CCMPN=PARAM_CCMPN AND A.CCLNT=PARAM_CODQRY AND A.SLBWEB='A' AND A.SSTCLB='E' AND A.SESTRG='A') OR
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_LIB_CONSULTA_RELACION_DATOS_CABECERA', PARAMETROS, '');
END
GO
...
BEGIN
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_LIB_CONSULTA_RELACION_DATOS_DETALLE', PARAMETROS, '');
END
GO
...
BEGIN
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_LIB_CONSULTA_LIBERACIONES_GENERADAS_SGO_CABECERA', PARAMETROS, '');
END
GO