...
BEGIN
    ...
    DECLARE C_ALMAPER CURSOR FOR
		SELECT
            ...
            D.STPENT1 AS STPENT1, D.STPENT2 AS STPENT2, D.CRPRS1 AS CRPRS1, D.CRPRS2 AS CRPRS2, D.FFRMRP1 AS FFRMRP1, D.FFRMRP2 AS FFRMRP2, D.HULTAC1 AS HULTAC1, D.HULTAC2 AS HULTAC2,
            E.STPENT1 AS STPENT3, E.STPENT2 AS STPENT4, E.CRPRS1 AS CRPRS3, E.CRPRS2 AS CRPRS4, E.FFRMRP1 AS FFRMRP3, E.FFRMRP2 AS FFRMRP4, E.HULTAC1 AS HULTAC3, E.HULTAC2 AS HULTAC4,
            F.STPENT1 AS STPENT5, F.STPENT2 AS STPENT6, F.CRPRS1 AS CRPRS5, F.CRPRS2 AS CRPRS6, F.FFRMRP1 AS FFRMRP5, F.FFRMRP2 AS FFRMRP6, F.HULTAC1 AS HULTAC5, F.HULTAC2 AS HULTAC6,
            -- Exwarrant
            G.NEXWRR
        FROM
            -- Operaciones ZZWM06
