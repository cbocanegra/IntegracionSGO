...
BEGIN
    ...
    DECLARE C_ALMAPER CURSOR FOR
		SELECT
            ...
            D.STPENT1 AS STPENT1, D.CRPRS1 AS CRPRS1, D.FFRMRP1 AS FFRMRP1, D.HULTAC1 AS HULTAC1, D.STPENT2 AS STPENT2, D.CRPRS2 AS CRPRS2, D.FFRMRP2 AS FFRMRP2, D.HULTAC2 AS HULTAC2,
            E.STPENT1 AS STPENT3, E.CRPRS1 AS CRPRS3, E.FFRMRP1 AS FFRMRP3, E.HULTAC1 AS HULTAC3, E.STPENT2 AS STPENT4, E.CRPRS2 AS CRPRS4, E.FFRMRP2 AS FFRMRP4, E.HULTAC2 AS HULTAC4,
            F.STPENT1 AS STPENT5, F.CRPRS1 AS CRPRS5, F.FFRMRP1 AS FFRMRP5, F.HULTAC1 AS HULTAC5, F.STPENT2 AS STPENT6, F.CRPRS2 AS CRPRS6, F.FFRMRP2 AS FFRMRP6, F.HULTAC2 AS HULTAC6,
            -- Exwarrant
            G.NEXWRR
        FROM
            -- Operaciones ZZWM06
            DC@ALMAPER.ZZWM06 A--ok
            -- Almacenes RZZM23
            INNER JOIN DC@ALMAPER.RZZM23 B ON A.CTPOAL = B.CTPOAL AND A.CALMCM = B.CALMCM--ok
            -- Solicitudes de prórroga ZZWW21
            INNER JOIN DC@ALMAPER.ZZWW21 C ON A.NOPRCN = C.NOPRCN--ok
            LEFT OUTER JOIN -- Almacenera
            (
	            SELECT
					D1.NSLCPR,					
					'A' AS STPENT1,
				...
				FROM
				(
					SELECT row_number() over(partition by NSLCPR) as fila, D.NSLCPR, D.CRPRS, D.FFRMRP, D.HULTAC FROM  DC@ALMAPER.ZZWT94 D WHERE  D.STPENT='A'
				) D1
				GROUP BY D1.NSLCPR
            ) D ON C.NSLCPR=D.NSLCPR
            LEFT OUTER JOIN -- Financiador
            (
	            SELECT
					D1.NSLCPR,					
					'B' AS STPENT1,
				...
				FROM
				(
					SELECT row_number() over(partition by NSLCPR) as fila, D.NSLCPR, D.CRPRS, D.FFRMRP, D.HULTAC FROM  DC@ALMAPER.ZZWT94 D WHERE  D.STPENT='B'
				) D1
				GROUP BY D1.NSLCPR
            ) E ON C.NSLCPR=E.NSLCPR
            ...
            (
				...
				FROM
				(
					SELECT row_number() over(partition by NSLCPR) as fila, D.NSLCPR, D.CRPRS, D.FFRMRP, D.HULTAC FROM  DC@ALMAPER.ZZWT94 D WHERE  D.STPENT='C'
				) D1
				GROUP BY D1.NSLCPR
            ) F ON C.NSLCPR=F.NSLCPR
            -- Exwarrant ZZWT23
    ...
    DECLARE C_RNSLIB CURSOR FOR
        ...
        FROM
            ...
            DC@RNSLIB.ZZWM06 A
            -- Almacenes RZZM23
            INNER JOIN DC@RNSLIB.RZZM23 B ON A.CTPOAL = B.CTPOAL AND A.CALMCM = B.CALMCM
            -- Solicitudes de prórroga ZZWW21
            INNER JOIN DC@RNSLIB.ZZWW21 C ON A.NOPRCN = C.NOPRCN
            LEFT OUTER JOIN -- Almacenera
            (
	            SELECT
					D1.NSLCPR,					
				...
				FROM
				(
					SELECT row_number() over(partition by NSLCPR) as fila, D.NSLCPR, D.CRPRS, D.FFRMRP, D.HULTAC FROM  DC@RNSLIB.ZZWT94 D WHERE  D.STPENT='A'
				) D1
				GROUP BY D1.NSLCPR
            ) D ON C.NSLCPR=D.NSLCPR
            LEFT OUTER JOIN -- Financiador
            (
				...
				FROM
				(
					SELECT row_number() over(partition by NSLCPR) as fila, D.NSLCPR, D.CRPRS, D.FFRMRP, D.HULTAC FROM  DC@RNSLIB.ZZWT94 D WHERE  D.STPENT='B'
				) D1
				GROUP BY D1.NSLCPR
            ) E ON C.NSLCPR=E.NSLCPR
            LEFT OUTER JOIN -- Cliente
            (
				...
				FROM
				(
					SELECT row_number() over(partition by NSLCPR) as fila, D.NSLCPR, D.CRPRS, D.FFRMRP, D.HULTAC FROM  DC@RNSLIB.ZZWT94 D WHERE  D.STPENT='C'
				) D1
				GROUP BY D1.NSLCPR
            ) F ON C.NSLCPR=F.NSLCPR
            -- Exwarrant ZZWT23
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_PRG_CONSULTA_PRORROGAS_WAR_VIGENTES', PARAMETROS, '');
END
GO
...
BEGIN
    ...
    DECLARE C_ALMA CURSOR FOR
		...
		INNER JOIN DC@ALMAPER.ZZWW21 A2 ON A2.NOPRCN=A1.NOPRCN
		WHERE (PARAM_STPQRY='C' AND A1.CCMPN=PARAM_CCMPN AND A1.CCLNT=PARAM_CODQRY AND A2.SSTSLP='S') OR
			  (PARAM_STPQRY='B' AND A1.CCMPN=PARAM_CCMPN AND A1.CFNNC=PARAM_CODQRY AND A2.SSTSLP='C') OR
			  (PARAM_STPQRY='S' AND NSLCPR=PARAM_CODQRY);
    ...
    DECLARE C_RNSLIB CURSOR FOR
		...
		INNER JOIN DC@RNSLIB.ZZWW21 A2 ON A2.NOPRCN=A1.NOPRCN
		WHERE (PARAM_STPQRY='C' AND A1.CCMPN=PARAM_CCMPN AND A1.CCLNT=PARAM_CODQRY AND A2.SSTSLP='S') OR
			  (PARAM_STPQRY='B' AND A1.CCMPN=PARAM_CCMPN AND A1.CFNNC=PARAM_CODQRY AND A2.SSTSLP='C') OR
			  (PARAM_STPQRY='S' AND NSLCPR=PARAM_CODQRY);
	...
	CALL INTEGRASGO.SP_INTSGO_GEN_ILOG('SP_INTSGO_PRG_CONSULTA_RELACION_DATOS_PRORROGA', PARAMETROS, '');
END
GO
